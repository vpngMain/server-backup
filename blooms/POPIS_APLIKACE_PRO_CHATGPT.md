...
- **7% marže + doprava** = (cena + doprava) × 1.07
- **VIP Eur** = (cena + doprava) + (100 / unit_per_cc)
- **VIP CZK** = VIP Eur × volitelný kurz
- **D1 (cena obchod)** = cena + doprava×eurKurz×1.12×2 (cena = sales×eurKurz, doprava na jednotku×eurKurz×1.12×2)
- **D4** = průměr mezi **VIP Eur** a **Sales Price** (zaokrouhleno na 2 des. místa)
